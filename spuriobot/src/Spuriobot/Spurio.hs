...
mkDBFailures jobId JobInfo { jobDate, webUrl, runnerId, runnerName, jobName } fails =
    let mk (code, _) = DB.Failure jobId code jobDate (render' webUrl) runnerId runnerName jobName
